import { GuestbookCreateForm } from "./form";

export let metadata = {
  title: "Lens guestbook",
  description: "Guestbook example for Lens frames",
};
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      <main className="flex flex-col items-center justify-center flex-1 px-4 sm:px-20 text-center">
        ...
        <h1 className="text-lg sm:text-2xl font-bold mb-2">Lens Guestbook</h1>
        <h2 className="text-md sm:text-xl mx-4">
          Create a new guestbook for Lens profiles to sign
        </h2>
